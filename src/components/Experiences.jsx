    ...
    <div className="border-b border-neutral-900 pb-4">
      ...
      <div>
        {EXPERIENCES.map((experience, index) => {
          ...
          return (
            <div key={index} ref={experienceRef} className="mb-8 flex flex-wrap lg:justify-center">
              ...
              <motion.div
                ...
                initial={{ opacity: 0, x: -1000 }} // Start off to the left
                animate={isInView ? { opacity: 1, x: 0 } : {}} // Slide into view when in viewport
              ...
              >
                ...
                <div>
                  {experience.technologies.map((tech, techIndex) => (
                    <span
                      key={techIndex}
                      className="mr-2 mt-4 rounded bg-neutral-900 px-3 py-1 text-sm font-medium text-violet-500"
                    >
                      {tech}
                    </span>
                  ))}
